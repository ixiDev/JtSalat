...
private class SettingsObservableWrapper(
    ...
    private inline fun <reified T> createAndRegisterListener(
        key: String,
...
fun Settings.asObservableSettings(): ObservableSettings = SettingsObservableWrapper(this)